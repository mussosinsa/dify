const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний D-GEN AI.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API D-GEN AI, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'ССО',
        5: 'Согласованные SLA от D-GEN AI Partners',
        ...
        7: 'Обновления и обслуживание от D-GEN AI официально',
    ...
    community: {
      features: {
        ...
        2: 'Соответствует лицензии D-GEN AI с открытым исходным кодом',
