const translation = {
  ...
  marketplace: {
    ...
    viewMore: '查看更多',
    verifiedTip: '此插件由 D-GEN AI 认证',
    partnerTip: '此插件由 D-GEN AI 合作伙伴认证',
  },
  task: {
  ...
  requestAPlugin: '申请插件',
  publishPlugins: '发布插件',
  difyVersionNotCompatible: '当前 D-GEN AI 版本不兼容该插件，其最低版本要求为 {{minimalDifyVersion}}',
  auth: {
    default: '默认',
    custom: '自定义',
    setDefault: '设为默认',
