const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань D-GEN AI.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API D-GEN AI, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'Угода про рівень обслуговування за домовленістю від D-GEN AI Partners',
        3: 'Кілька робочих областей і управління підприємством',
        0: 'Масштабовані рішення для розгортання корпоративного рівня',
        7: 'Оновлення та обслуговування від D-GEN AI Official',
      },
    ...
    community: {
      features: {
        ...
        2: 'Відповідає ліцензії D-GEN AI з відкритим вихідним кодом',
