const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію D-GEN AI з безкоштовним цитатою',
  },
  overview: {
    title: 'Огляд',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> D-GEN AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Chrome D-GEN AI Chatbot',
        copied: 'Скопійовано',
        copy: 'Скопіювати',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Клієнт-Web-D-GEN AI',
