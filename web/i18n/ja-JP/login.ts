const translation = {
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、D-GEN AI Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'D-GEN AI へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの D-GEN AI Enterprise ライセンスの有効期限が切れています。D-GEN AI を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの D-GEN AI Enterprise ライセンスが非アクティブです。D-GEN AI を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'D-GEN AI ライセンスサーバーへの接続に失敗しました。続けて D-GEN AI を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
