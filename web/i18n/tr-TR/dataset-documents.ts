const translation = {
  list: {
    title: 'Belgeler',
    desc: 'Bilginin tüm dosyaları burada gösterilir ve Bilginin tamamı D-GEN AI alıntılarına veya Sohbet eklentisi üzerinden dizine eklenebilir.',
    addFile: 'Dosya Ekle',
    addPages: 'Sayfa Ekle',
    addUrl: 'URL Ekle',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: 'D-GEN AI, Notion\'dan periyodik olarak dosyaları indirir ve işlemeyi tamamlar.',
      },
    },
    delete: {
