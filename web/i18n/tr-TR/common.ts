const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'D-GEN AI hesabı',
    langGeniusAccountTip: 'D-GEN AI hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, D-GEN AI\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'D-GEN AI tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, D-GEN AI\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} şimdi mevcut.',
    latestAvailable: 'D-GEN AI {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
