const translation = {
  toVerifiedTip: {
    end: 'D-GEN AI Profesyonel Planı için.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Verilen kurumda kayıtlı veya istihdamda olduğumu onaylıyorum. D-GEN AI, kayıt veya istihdam kanıtı talep edebilir. Uygunluğumu yanlış beyan edersem, eğitim durumuma dayalı olarak başlangıçta feragat edilen her türlü ücreti ödemeyi kabul ediyorum.',
      },
  ...
  rejectTitle: 'D-GEN AI Eğitim Doğrulamanız Rededildi',
  emailLabel: 'Şu anki e-posta adresin',
  submit: 'Gönder',
  rejectContent: 'Maalesef, Eğitim Doğrulama statüsüne uygun değilsiniz ve bu nedenle bu e-posta adresini kullanıyorsanız D-GEN AI Profesyonel Planı için özel %100 kuponu alamazsınız.',
  learn: 'Eğitim doğrulamasının nasıl yapılacağını öğrenin',
  successContent: 'Hesabınıza D-GEN AI Profesyonel planı için %100 indirim kuponu verdik. Kuponun geçerlilik süresi bir yıldır, lütfen bu süre içinde kullanın.',
  successTitle: 'D-GEN AI Eğitim Onayınız Var',
  notice: {
    expired: {
      summary: {
        line2: 'Ancak, artık yeni eğitim indirim kuponları için uygun değilsiniz.',
        line1: 'D-GEN AI\'e hala erişebilir ve kullanabilirsiniz.',
      },
