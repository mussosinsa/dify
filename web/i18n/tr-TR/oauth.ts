const translation = {
  tips: {
    notLoggedIn: 'Bu uygulama D-GEN AI Cloud hesabınıza erişmek istiyor',
    ...
    loggedIn: 'Bu uygulama D-GEN AI Cloud hesabınızdaki aşağıdaki bilgilere erişmek istiyor.',
