const translation = {
  ...
  tracing: {
    ...
    aliyun: {
      ...
      description: 'Alibaba Cloud tarafından sağlanan tamamen yönetilen ve bakım gerektirmeyen gözlemleme platformu, D-GEN AI uygulamalarının kutudan çıkar çıkmaz izlenmesi, takip edilmesi ve değerlendirilmesine olanak tanır.',
    },
    tencent: {
      title: 'Tencent APM',
