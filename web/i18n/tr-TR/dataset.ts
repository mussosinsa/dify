const translation = {
  ...
  intro1: 'Bilgi, D-GEN AI uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, D-GEN AI dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
