const translation = {
  ...
  marketplace: {
    ...
    sortBy: '排序方式',
    viewMore: '查看更多',
    difyMarketplace: 'D-GEN AI 市場',
    pluginsResult: '{{num}} 個結果',
    verifiedTip: '由 D-GEN AI 驗證',
    partnerTip: '由 D-GEN AI 合作夥伴驗證',
  },
  task: {
  ...
  difyVersionNotCompatible: '當前的 D-GEN AI 版本與此插件不兼容，請升級至所需的最低版本：{{minimalDifyVersion}}',
  auth: {
    setDefault: '設置為默認',
    useOAuth: '使用 OAuth',
    saveAndAuth: '保存並授權',
