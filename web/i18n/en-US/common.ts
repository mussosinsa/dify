const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to D-GEN AI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by D-GEN AI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across D-GEN AI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} is now available.',
    latestAvailable: 'D-GEN AI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
