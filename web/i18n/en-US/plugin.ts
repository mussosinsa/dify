const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by D-GEN AI',
    partnerTip: 'Verified by a D-GEN AI partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current D-GEN AI version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
