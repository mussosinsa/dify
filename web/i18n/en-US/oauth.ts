const translation = {
  tips: {
    loggedIn: 'This app wants to access the following information from your D-GEN AI Cloud account.',
    notLoggedIn: 'This app wants to access your D-GEN AI Cloud account',
