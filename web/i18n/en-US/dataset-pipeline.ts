const translation = {
  ...
  knowledgeDescriptionPlaceholder: 'Describe what is in this Knowledge Base. A detailed description allows AI to access the content of the dataset more accurately. If empty, D-GEN AI will use the default hit strategy. (Optional)',
