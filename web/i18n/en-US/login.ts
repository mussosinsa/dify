const translation = {
  ...
  license: {
    tip: 'Before starting D-GEN AI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on D-GEN AI',
  invalid: 'The link has expired',
  explore: 'Explore D-GEN AI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on D-GEN AI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The D-GEN AI Enterprise license for your workspace has expired. Please contact your administrator to continue using D-GEN AI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect D-GEN AI license server. Please contact your administrator to continue using D-GEN AI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The D-GEN AI Enterprise license for your workspace is inactive. Please contact your administrator to continue using D-GEN AI.',
  webapp: {
    login: 'Login',
