const translation = {
  ...
  welcome: 'Benvenuto su D-GEN AI, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare D-GEN AI Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su D-GEN AI',
  invalid: 'Il link è scaduto',
  explore: 'Esplora D-GEN AI',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su D-GEN AI e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze D-GEN AI. Contatta il tuo amministratore per continuare a utilizzare D-GEN AI.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza D-GEN AI Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare D-GEN AI.',
  licenseInactiveTip: 'La licenza D-GEN AI Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare D-GEN AI.',
