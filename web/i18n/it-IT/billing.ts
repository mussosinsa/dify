const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      'Si riferisce al numero di chiamate API che invocano solo le capacità di elaborazione della base di conoscenza di D-GEN AI.',
    receiptInfo:
    ...
    apiRateLimitTooltip: 'Il limite di utilizzo dell\'API si applica a tutte le richieste effettuate tramite l\'API D-GEN AI, comprese la generazione di testo, le conversazioni chat, le esecuzioni di flussi di lavoro e l\'elaborazione di documenti.',
    getStarted: 'Inizia',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA negoziati dai partner D-GEN AI',
        7: 'Aggiornamenti e manutenzione da parte di D-GEN AI ufficialmente',
      },
    ...
    community: {
      features: {
        ...
        2: 'Conforme alla licenza Open Source D-GEN AI',
