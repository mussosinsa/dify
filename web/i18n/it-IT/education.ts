const translation = {
  toVerifiedTip: {
    ...
    end: 'per il Piano Professionale D-GEN AI.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Confermo di essere iscritto o impiegato presso l\'istituzione fornita. D-GEN AI può richiedere una prova di iscrizione/impegno. Se rappresento erroneamente la mia idoneità, accetto di pagare eventuali tasse inizialmente esonerate in base al mio stato di istruzione.',
  ...
  successTitle: 'Hai ottenuto l\'istruzione D-GEN AI verificata',
  submitError: 'Invio del modulo non riuscito. Per favore riprova più tardi.',
  submit: 'Invia',
  currentSigned: 'ATTUALMENTE ACCEDUTO COME',
  successContent: 'Abbiamo emesso un coupon sconto del 100% per il piano D-GEN AI Professionale sul tuo account. Il coupon è valido per un anno, ti preghiamo di utilizzarlo entro il periodo di validità.',
  learn: 'Scopri come far verificare la tua istruzione',
  emailLabel: 'La tua email attuale',
  rejectContent: 'Sfortunatamente, non sei idoneo per lo status di Educazione Verificata e quindi non puoi ricevere il coupon esclusivo del 100% per il Piano Professionale D-GEN AI se usi questo indirizzo email.',
  rejectTitle: 'La tua verifica educativa D-GEN AI è stata rifiutata.',
  notice: {
    expired: {
      summary: {
        line1: 'Puoi ancora accedere e usare D-GEN AI.',
