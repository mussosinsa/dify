const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di D-GEN AI con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di D-GEN AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di D-GEN AI Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
