const translation = {
  ...
  home: {
    ...
    cards: {
      ...
      resume: {
        title: '사용자님을 위한 이력서 작성을 도와드릴게요.',
        details: [
          '최적의 이력서 포맷 추천해드릴게요.',
          '개인 맞춤 합격자 서류를 작성할게요.',
          '읽는사람이 볼 수 있게 작성해드릴게요.',
        ],
        badge: '몇 초',
      },
      sms: {
        title: 'SMS 메세지 템플릿 디자인 해드릴게요.',
        details: [
          '아이캐치 Title과 Summary를 정리해드릴게요.',
          '사람들이 볼만한 Hooking 포인트 작성해드릴게요.',
          '최대 5개까지 카피라이팅 작성해드릴게요.',
        ],
        badge: '몇 초',
      },
      travel: {
      ...
      news: {
        title: '금융 관련 최신 뉴스를 추천해드릴게요.',
        details: [
          '명확하고 믿을 수 있는 자료로 분석해드릴게요.',
          '요약된 정보로 추천해드릴게요.',
          '이해할 수 있는 통계로 제공해드릴게요.',
        ],
        badge: '몇 초',
      },
      portfolio: {
        title: '사용자님을 위한 포트폴리오 작성도 가능해요.',
        details: [
          '이력서를 검토하고 개선사항을 알려드릴게요.',
          '커리어의 장점을 분석해드릴게요.',
          '이력에 맞는 스토리로 작성해드릴게요.',
        ],
        badge: '몇 초',
      ...
      problem: {
        title: '막힌 문제 해결에 도움이 필요하신가요?',
        details: [
          '문제 해결을 위한 목표를 설정해드릴게요.',
          '데이터와 근거를 함께 안내해드릴게요.',
          '해결책을 제공해드릴게요.',
        ],
        badge: '몇 초',
      ...
      gpt: {
        title: '우리 회사 정보를 기반으로 GPT를 만들고 싶으신가요?',
        details: [
          '자사의 정보를 담은 문서를 수집해드릴게요.',
          '구조화된 데이터베이스로 제작해드릴게요.',
          '바로 사용 가능한 GPT를 생성해드릴게요.',
        ],
        badge: '몇 초',
      },
    },
    actions: {
      ...
      pinnedTitle: '고정됨',
      pinnedEmpty: '무엇을 도와드릴까요?',
    },
    inputPlaceholder: '이미지/음성/파일을 업로드해주세요. (예: 우산 사진 올려줘)',
  },
  you: '너',
  avatar: {
