const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Hoặc dùng thử phiên bản đám mây của D-GEN AI với gói miễn phí',
  },
  overview: {
    title: 'Tổng quan',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Giúp người dùng hiểu dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của D-GEN AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Cài đặt tiện ích mở rộng D-GEN AI Chatbot cho Chrome',
        copied: 'Đã sao chép',
        copy: 'Sao chép',
      },
      qrcode: {
