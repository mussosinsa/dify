const translation = {
  ...
  intro1: 'Bộ kiến thức có thể được tích hợp vào ứng dụng D-GEN AI ',
  ...
  externalAPIPanelDescription: 'API kiến thức bên ngoài được sử dụng để kết nối với cơ sở kiến thức bên ngoài D-GEN AI và truy xuất kiến thức từ cơ sở kiến thức đó.',
  chunkingMode: {
    general: 'Tổng quát',
