const translation = {
  ...
  welcome: 'Chào mừng bạn đến với D-GEN AI, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của D-GEN AI, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại D-GEN AI',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá D-GEN AI',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên D-GEN AI và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép D-GEN AI Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng D-GEN AI.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép D-GEN AI Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng D-GEN AI.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép D-GEN AI. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng D-GEN AI.',
  webapp: {
