const translation = {
  toVerifiedTip: {
    ...
    end: 'pentru Planul Profesional D-GEN AI.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Confirm că sunt înscris sau angajat la instituția menționată. D-GEN AI poate solicita dovada înscrierii/angajării. Dacă îmi reprezint greșit eligibilitatea, sunt de acord să plătesc orice taxe inițial renunțate pe baza statutului meu educațional.',
  ...
  rejectContent: 'Din păcate, nu ești eligibil pentru statutul de Verificat Educațional și, prin urmare, nu poți primi cuponul exclusiv de 100% pentru Planul Profesional D-GEN AI dacă folosești această adresă de email.',
  successTitle: 'Ai obținut educația D-GEN AI verificată',
  learn: 'Învățați cum să verificați educația',
  submit: 'Trimite',
  emailLabel: 'Emailul tău curent',
  currentSigned: 'CONEXIUNE ÎN PREZENT CA',
  rejectTitle: 'Verificarea educațională D-GEN AI a fost respinsă',
  successContent: 'Am emis un cupon de discount de 100% pentru planul Professional D-GEN AI pe contul dumneavoastră. Cuponul este valabil timp de un an, vă rugăm să îl utilizați în perioada de valabilitate.',
  notice: {
    expired: {
      summary: {
        line2: 'Cu toate acestea, nu mai ești eligibil pentru noi cupoane de reducere la educație.',
        line1: 'Încă poți accesa și folosi D-GEN AI.',
      },
