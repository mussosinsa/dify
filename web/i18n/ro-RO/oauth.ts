const translation = {
  tips: {
    ...
    loggedIn: 'Această aplicație vrea să acceseze următoarele informații din contul tău D-GEN AI Cloud.',
    notLoggedIn: 'Această aplicație vrea să acceseze contul tău D-GEN AI Cloud',
