const translation = {
  ...
  welcome: 'Bine ai venit la D-GEN AI, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe D-GEN AI Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe D-GEN AI',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează D-GEN AI',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe D-GEN AI și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe D-GEN AI. Contactați administratorul pentru a continua să utilizați D-GEN AI.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența D-GEN AI Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați D-GEN AI.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența D-GEN AI Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați D-GEN AI.',
  webapp: {
