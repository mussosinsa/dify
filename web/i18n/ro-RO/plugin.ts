const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Piața D-GEN AI',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener D-GEN AI',
    verifiedTip: 'Verificat de D-GEN AI',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Versiunea curentă D-GEN AI nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalDifyVersion}}',
