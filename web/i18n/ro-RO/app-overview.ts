const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a D-GEN AI cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a D-GEN AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome D-GEN AI Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
