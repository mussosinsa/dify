const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont D-GEN AI',
    langGeniusAccountTip: 'Contul D-GEN AI și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în D-GEN AI pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de D-GEN AI vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile D-GEN AI.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} este acum disponibil.',
    latestAvailable: 'D-GEN AI {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
