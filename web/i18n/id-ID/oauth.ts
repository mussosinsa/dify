const translation = {
  tips: {
    loggedIn: 'Aplikasi ini ingin mengakses informasi berikut dari akun D-GEN AI Cloud Anda.',
    notLoggedIn: 'Aplikasi ini ingin mengakses akun D-GEN AI Cloud Anda',
