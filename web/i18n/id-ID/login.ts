const translation = {
  ...
  license: {
    tip: 'Sebelum memulai Edisi Komunitas D-GEN AI, baca GitHub',
  ...
  joinTipEnd: 'tim di D-GEN AI',
  dontHave: 'Belum?',
  passwordChangedTip: 'Kata sandi Anda telah berhasil diubah',
  validate: 'Memvalidasi',
  resetPasswordDesc: 'Ketik email yang Anda gunakan untuk mendaftar di D-GEN AI dan kami akan mengirimkan email reset kata sandi kepada Anda.',
  licenseLostTip: 'Gagal menghubungkan server lisensi D-GEN AI. Hubungi administrator Anda untuk terus menggunakan D-GEN AI.',
  signBtn: 'Masuk',
  sendResetLink: 'Kirim tautan reset',
  createAndSignIn: 'Buat dan masuk',
  licenseExpiredTip: 'Lisensi D-GEN AI Enterprise untuk ruang kerja Anda telah kedaluwarsa. Hubungi administrator Anda untuk terus menggunakan D-GEN AI.',
  email: 'Alamat email',
  noLoginMethodTip: 'Silakan hubungi admin sistem untuk menambahkan metode autentikasi.',
  adminInitPassword: 'Kata sandi inisialisasi admin',
  licenseInactiveTip: 'Lisensi D-GEN AI Enterprise untuk ruang kerja Anda tidak aktif. Hubungi administrator Anda untuk terus menggunakan D-GEN AI.',
  rightTitle: 'Buka potensi penuh LLM',
  welcome: '👋 Selamat datang di D-GEN AI, silakan login untuk melanjutkan.',
