const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Undangan terkirim, dan mereka dapat masuk ke D-GEN AI untuk mengakses data tim Anda.',
    role: 'PERAN',
    ok: 'OKE',
  ...
  provider: {
    ...
    openaiHosted: {
      desc: 'Layanan hosting OpenAI yang disediakan oleh D-GEN AI memungkinkan Anda menggunakan model seperti GPT-3.5. Sebelum kuota uji coba habis, Anda harus menyiapkan penyedia model lain.',
  ...
  apiBasedExtension: {
    ...
    title: 'Ekstensi API menyediakan manajemen API terpusat, menyederhanakan konfigurasi agar mudah digunakan di seluruh aplikasi D-GEN AI.',
    type: 'Jenis',
