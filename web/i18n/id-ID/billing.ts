const translation = {
  ...
  plansCommon: {
    ...
    messageRequest: {
      tooltip: 'Kredit pesan disediakan untuk membantu Anda mencoba berbagai model OpenAI dengan mudah di D-GEN AI. Kredit digunakan berdasarkan jenis model. Setelah habis, Anda dapat beralih ke kunci API OpenAI Anda sendiri.',
    },
    annotatedResponse: {
    ...
    apiRateLimitTooltip: 'Batas Tarif API berlaku untuk semua permintaan yang dibuat melalui D-GEN AI API, termasuk pembuatan teks, percakapan obrolan, eksekusi alur kerja, dan pemrosesan dokumen.',
    ...
    ragAPIRequestTooltip: 'Mengacu pada jumlah panggilan API yang hanya memanggil kemampuan pemrosesan basis pengetahuan D-GEN AI.',
  ...
  plans: {
    ...
    community: {
      features: {
        ...
        2: 'Sesuai dengan Lisensi Sumber Terbuka D-GEN AI',
      },
      price: 'Bebas',
    ...
    enterprise: {
      features: {
        5: 'SLA yang Dinegosiasikan oleh Mitra D-GEN AI',
        3: 'Beberapa Ruang Kerja & Manajemen Perusahaan',
        4: 'SSO',
        2: 'Fitur Eksklusif Enterprise',
        7: 'Pembaruan dan Pemeliharaan oleh D-GEN AI Secara Resmi',
