  ...
  nodes: {
    ...
    knowledgeBase: {
      chunkStructureTip: {
        ...
        message: 'Baza wiedzy D-GEN AI obsługuje trzy struktury fragmentacji: Ogólne, Nadrzędne-podrzędne oraz Q&A. Każda baza wiedzy może mieć tylko jedną strukturę. Dane wyjściowe z poprzedniego węzła muszą być wyrównane z wybraną strukturą fragmentów. Należy pamiętać, że wybór struktury fragmentacji ma wpływ na dostępne metody indeksowania.',
      },
