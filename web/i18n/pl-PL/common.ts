const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto D-GEN AI',
    langGeniusAccountTip: 'Twoje konto D-GEN AI i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do D-GEN AI, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez D-GEN AI pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach D-GEN AI.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} jest teraz dostępny.',
    latestAvailable: 'D-GEN AI {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
