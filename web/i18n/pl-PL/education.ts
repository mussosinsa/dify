const translation = {
  toVerifiedTip: {
    ...
    end: 'dla Profesjonalnego Planu D-GEN AI.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Potwierdzam, że jestem zapisany lub zatrudniony w podanej instytucji. D-GEN AI może wymagać dowodu zapisania/zatrudnienia. Jeśli wprowadzę w błąd dotyczący mojej zdolności do uczestnictwa, zgadzam się zapłacić wszelkie opłaty, które zostały początkowo zaniechane w oparciu o mój status edukacyjny.',
      },
  ...
  submit: 'Zatwierdź',
  rejectContent: 'Niestety, nie kwalifikujesz się do statusu Zweryfikowanej Edukacji i w związku z tym nie możesz otrzymać ekskluzywnego kuponu 100% na plan D-GEN AI Professional, jeśli korzystasz z tego adresu e-mail.',
  successContent: 'Wydaliśmy kupon rabatowy na 100% dla planu D-GEN AI Professional na Twoje konto. Kupon jest ważny przez jeden rok, prosimy o jego użycie w okresie ważności.',
  currentSigned: 'AKTUALNIE ZALOGOWANY JAKO',
  successTitle: 'Masz zweryfikowane wykształcenie D-GEN AI',
  rejectTitle: 'Twoja weryfikacja edukacyjna D-GEN AI została odrzucona',
  ...
  notice: {
    expired: {
      summary: {
        line1: 'Możesz nadal uzyskać dostęp i korzystać z D-GEN AI.',
