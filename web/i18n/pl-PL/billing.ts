const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      'Odnosi się do liczby wywołań API wykorzystujących tylko zdolności przetwarzania bazy wiedzy D-GEN AI.',
    receiptInfo:
    ...
    self: 'Samo-hostowane',
    apiRateLimitTooltip: 'Limit aktywności API dotyczy wszystkich żądań składanych za pośrednictwem API D-GEN AI, w tym generowania tekstu, rozmów czatowych, wykonywania przepływów pracy i przetwarzania dokumentów.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Aktualizacje i konserwacja przez D-GEN AI oficjalnie',
        5: 'Umowy SLA wynegocjowane przez D-GEN AI Partners',
    ...
    community: {
      features: {
        ...
        2: 'Zgodny z licencją D-GEN AI Open Source',
