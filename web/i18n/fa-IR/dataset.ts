const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه D-GEN AI ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از D-GEN AI و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
