const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'یا نسخه ابری D-GEN AI با سهمیه رایگان را امتحان کنید',
  },
  overview: {
    title: 'نمای کلی',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'به بازدیدکنندگان کمک می‌کند تا بفهمند برنامه چه داده‌هایی را جمع‌آوری می‌کند، به سیاست حفظ حریم خصوصی D-GEN AI نگاه کنید <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'نصب افزونه Chrome Chatbot D-GEN AI',
        copied: 'کپی شد',
        copy: 'کپی',
      },
      qrcode: {
