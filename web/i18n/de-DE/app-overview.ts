const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von D-GEN AI mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Hilft Besuchern zu verstehen, welche Daten die Anwendung sammelt, siehe D-GEN AIs <privacyPolicyLink>Datenschutzrichtlinie</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installieren Sie die D-GEN AI Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
