const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von D-GEN AI aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die D-GEN AI-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO (Single Sign-On)',
        'Vereinbarte SLAs mit D-GEN AI-Partnern',
        'Erweiterte Sicherheitsfunktionen und Kontrollen',
        'Offizielle Updates und Wartung durch D-GEN AI',
    ...
    community: {
      ...
      features: [
        ...
        'Entspricht der D-GEN AI Open-Source-Lizenz',
      ],
    },
    premium: {
