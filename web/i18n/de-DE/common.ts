const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'D-GEN AI-Konto',
    langGeniusAccountTip: 'Ihr D-GEN AI-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei D-GEN AI anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von D-GEN AI ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in D-GEN AIs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} ist jetzt verfügbar.',
    latestAvailable: 'D-GEN AI {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
