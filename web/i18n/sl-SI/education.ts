const translation = {
  toVerifiedTip: {
    end: 'za profesionalni načrt D-GEN AI.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Potrjujem, da sem vpisan ali zaposlen na navedenem zavodu. D-GEN AI lahko zahteva dokazilo o vpisu/zaposlitvi. Če napačno predstavim svojo upravičenost, se strinjam, da plačam morebitne pristojbine, ki so bile sprva oproščene na podlagi mojega izobraževalnega statusa.',
  ...
  successContent: 'Za vaše račune smo izdali kupon za 100% popust na profesionalni načrt D-GEN AI. Kupon je veljaven eno leto, prosimo, uporabite ga v veljavnem obdobju.',
  successTitle: 'Imate verifikacijo izobraževanja D-GEN AI',
  submitError: 'Pošiljanje obrazca ni uspelo. Prosimo, poskusite znova kasneje.',
  submit: 'Predloži',
  rejectTitle: 'Vaša D-GEN AI izobraževalna verifikacija je bila zavrnjena.',
  learn: 'Naučite se, kako preveriti izobrazbo',
  emailLabel: 'Vaš trenutni elektronski naslov',
  currentSigned: 'Trenutno prijavljen kot',
  rejectContent: 'Na žalost niste upravičeni do statusa Verificirane izobrazbe in zato ne morete prejeti ekskluzivnega 100-odstotnega kupona za D-GEN AI profesionalni načrt, če uporabljate ta e-poštni naslov.',
  notice: {
    expired: {
      summary: {
        line1: 'Še vedno lahko dostopate in uporabljate D-GEN AI.',
