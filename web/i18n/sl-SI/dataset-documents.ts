const translation = {
  list: {
    title: 'Dokumenti',
    desc: 'Vse datoteke znanja so prikazane tukaj, celotno znanje pa je mogoče povezati s citati D-GEN AI ali indeksirati prek vtičnika Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'D-GEN AI bo občasno prenesel datoteke iz Notion in dokončal obdelavo.',
      },
    },
    delete: {
