const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani D-GEN AI',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja D-GEN AI',
    ...
    difyMarketplace: 'D-GEN AI Marketplace',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Trenutna različica D-GEN AI ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalDifyVersion}}',
