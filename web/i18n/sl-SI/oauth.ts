const translation = {
  tips: {
    notLoggedIn: 'Ta aplikacija želi dostopati do vašega D-GEN AI Cloud računa',
    loggedIn: 'Ta aplikacija želi dostopati do naslednjih informacij iz vašega računa D-GEN AI Cloud.',
