const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Nanaša se na število API klicev, ki vključujejo samo sposobnosti obdelave baze znanja D-GEN AI.',
    ...
    apiRateLimitTooltip: 'API omejitev hitrosti velja za vse poizvedbe, opravljene prek D-GEN AI API, vključno z generiranjem besedila, klepetnimi pogovori, izvajanjem delovnih tokov in obdelavo dokumentov.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Posodobitve in vzdrževanje s strani D-GEN AI Official',
        5: 'Dogovorjene pogodbe o ravni storitev s strani D-GEN AI Partners',
    ...
    community: {
      features: {
        2: 'Skladen z odprtokodno licenco D-GEN AI',
