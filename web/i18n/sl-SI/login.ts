const translation = {
  ...
  welcome: 'Dobrodošli v D-GEN AI, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z D-GEN AI Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na D-GEN AI',
  invalid: 'Povezava je potekla',
  explore: 'Razišči D-GEN AI',
  ...
  licenseExpiredTip: 'Licenca za D-GEN AI Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati D-GEN AI, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na D-GEN AI, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom D-GEN AI ni uspela. Če želite še naprej uporabljati D-GEN AI, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca D-GEN AI Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati D-GEN AI, se obrnite na skrbnika.',
  webapp: {
