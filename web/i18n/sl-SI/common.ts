const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'D-GEN AI račun',
    langGeniusAccountTip: 'Vaš D-GEN AI račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v D-GEN AI bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja D-GEN AI, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah D-GEN AI.',
    add: 'Dodajanje razširitve API-ja',
  },
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'D-GEN AI {{version}} je zdaj na voljo.',
    latestAvailable: 'D-GEN AI {{version}} je najnovejša različica, ki je na voljo.',
