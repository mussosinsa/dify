const translation = {
  toVerifiedTip: {
    ...
    end: 'pour le Plan Professionnel D-GEN AI.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Je confirme que je suis inscrit ou employé dans l\'institution indiquée. D-GEN AI peut demander une preuve d\'inscription/employé. Si je falsifie mon éligibilité, j\'accepte de payer tous les frais initialement annulés en fonction de mon statut éducatif.',
      },
  ...
  successTitle: 'Vous avez obtenu une éducation D-GEN AI vérifiée.',
  successContent: 'Nous avons émis un coupon de réduction de 100 % pour le plan D-GEN AI Professionnel sur votre compte. Le coupon est valable pendant un an, veuillez l\'utiliser dans la période de validité.',
  rejectTitle: 'Votre vérification éducative D-GEN AI a été rejetée.',
  submit: 'Soumettre',
  submitError: 'L\'envoi du formulaire a échoué. Veuillez réessayer plus tard.',
  toVerified: 'Faire vérifier l\'éducation',
  rejectContent: 'Malheureusement, vous n\'êtes pas éligible au statut Éducation Vérifié et ne pouvez donc pas recevoir le coupon exclusif de 100 % pour le Plan Professionnel D-GEN AI si vous utilisez cette adresse e-mail.',
  notice: {
    expired: {
      summary: {
        line2: 'Cependant, vous n\'êtes plus éligible pour de nouveaux bons de réduction pour l\'éducation.',
        line1: 'Vous pouvez toujours accéder à D-GEN AI et l\'utiliser.',
      },
