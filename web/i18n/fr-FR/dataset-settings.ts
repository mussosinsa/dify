const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Décrivez ce qui se trouve dans cette Connaissance. Une description détaillée permet à l\'IA d\'accéder au contenu de la Connaissance en temps opportun. Si vide, D-GEN AI utilisera la stratégie de hit par défaut.',
