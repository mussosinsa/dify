const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fait référence au nombre d\'appels API invoquant uniquement les capacités de traitement de la base de connaissances de D-GEN AI.',
    ...
    apiRateLimitTooltip: 'La limite de taux de l\'API s\'applique à toutes les demandes effectuées via l\'API D-GEN AI, y compris la génération de texte, les conversations de chat, les exécutions de flux de travail et le traitement de documents.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA négociés par les partenaires D-GEN AI',
        8: 'Assistance technique professionnelle',
        7: 'Mises à jour et maintenance par D-GEN AI officiellement',
    ...
    community: {
      features: {
        ...
        2: 'Conforme à la licence Open Source D-GEN AI',
      },
      name: 'Communauté',
