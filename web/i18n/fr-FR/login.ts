const translation = {
  ...
  welcome: 'Bienvenue sur D-GEN AI, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer D-GEN AI Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur D-GEN AI',
  invalid: 'Le lien a expiré',
  explore: 'Explorez D-GEN AI',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur D-GEN AI et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence D-GEN AI Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser D-GEN AI.',
  licenseLostTip: 'Échec de la connexion au serveur de licences D-GEN AI. Veuillez contacter votre administrateur pour continuer à utiliser D-GEN AI.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence D-GEN AI Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser D-GEN AI.',
