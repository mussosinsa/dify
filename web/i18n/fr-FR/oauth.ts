const translation = {
  tips: {
    ...
    notLoggedIn: 'Cette application veut accéder à votre compte D-GEN AI Cloud',
    ...
    loggedIn: 'Cette application veut accéder aux informations suivantes de votre compte D-GEN AI Cloud.',
  },
  scopes: {
    email: 'E-mail',
    name: 'Nom',
