const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de D-GEN AI avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de D-GEN AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome D-GEN AI Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Client-Web-D-GEN AI',
