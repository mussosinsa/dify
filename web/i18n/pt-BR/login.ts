const translation = {
  ...
  welcome: 'Bem-vindo ao D-GEN AI, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do D-GEN AI, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no D-GEN AI',
  invalid: 'O link expirou',
  explore: 'Explorar o D-GEN AI',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no D-GEN AI e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do D-GEN AI Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o D-GEN AI.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças D-GEN AI. Entre em contato com o administrador para continuar usando o D-GEN AI.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do D-GEN AI Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o D-GEN AI.',
  webapp: {
