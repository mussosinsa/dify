const translation = {
  tips: {
    notLoggedIn: 'Este aplicativo quer acessar sua conta do D-GEN AI Cloud',
    loggedIn: 'Este aplicativo quer acessar as seguintes informações da sua conta D-GEN AI Cloud.',
