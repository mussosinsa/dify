const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta D-GEN AI',
    langGeniusAccountTip: 'Sua conta D-GEN AI e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no D-GEN AI para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela D-GEN AI permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da D-GEN AI.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} já está disponível.',
    latestAvailable: 'D-GEN AI {{version}} é a última versão disponível.',
  },
  appMenus: {
