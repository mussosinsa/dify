const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do D-GEN AI.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API D-GEN AI, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Atualizações e manutenção por D-GEN AI oficialmente',
        ...
        5: 'SLAs negociados pela D-GEN AI Partners',
    ...
    community: {
      features: {
        ...
        2: 'Está em conformidade com a licença de código aberto D-GEN AI',
      },
      name: 'Comunidade',
