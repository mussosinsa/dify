const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se refiere al número de llamadas API que invocan solo las capacidades de procesamiento de base de conocimientos de D-GEN AI.',
    ...
    apiRateLimitTooltip: 'El límite de tasa de la API se aplica a todas las solicitudes realizadas a través de la API de D-GEN AI, incluidos la generación de texto, las conversaciones de chat, las ejecuciones de flujo de trabajo y el procesamiento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SLAs negociados con socios de D-GEN AI',
        'Seguridad y controles avanzados',
        'Actualizaciones y mantenimiento oficiales por parte de D-GEN AI',
    ...
    community: {
      ...
      features: [
        ...
        'Cumple con la licencia de código abierto de D-GEN AI',
      ],
    },
    premium: {
