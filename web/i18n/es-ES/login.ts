const translation = {
  ...
  welcome: 'Bienvenido a D-GEN AI, por favor inicia sesión para continuar.',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en D-GEN AI y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de D-GEN AI Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando D-GEN AI.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de D-GEN AI Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando D-GEN AI.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando D-GEN AI.',
  webapp: {
