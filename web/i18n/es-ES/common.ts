const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta D-GEN AI',
    langGeniusAccountTip: 'Tu cuenta D-GEN AI y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en D-GEN AI para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por D-GEN AI te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de D-GEN AI.',
  ...
  about: {
    ...
    nowAvailable: 'D-GEN AI {{version}} ya está disponible.',
    latestAvailable: 'D-GEN AI {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
