const translation = {
  tips: {
    ...
    notLoggedIn: 'Esta aplicación quiere acceder a su cuenta de D-GEN AI Cloud',
    loggedIn: 'Esta aplicación quiere acceder a la siguiente información de su cuenta de D-GEN AI Cloud.',
