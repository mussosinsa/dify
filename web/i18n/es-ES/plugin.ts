const translation = {
  ...
  marketplace: {
    ...
    discover: 'Descubrir',
    and: 'y',
    difyMarketplace: 'Mercado de D-GEN AI',
    verifiedTip: 'Verificado por D-GEN AI',
    partnerTip: 'Verificado por un socio de D-GEN AI',
  },
  task: {
  ...
  difyVersionNotCompatible:
    'La versión actual de D-GEN AI no es compatible con este plugin, por favor actualiza a la versión mínima requerida: {{minimalDifyVersion}}',
